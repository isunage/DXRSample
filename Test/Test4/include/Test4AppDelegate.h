#ifndef TEST4_APP_DELEGATE_H
#define TEST4_APP_DELEGATE_H
...
namespace test {
	class Test4AppDelegate:public Win32AppDelegate {
    private:
    ...
    public:
        Test4AppDelegate();
        Test4AppDelegate(int width, int height, std::string title);
    ...
    private:
        ...
        std::vector<std::shared_ptr<rtlib::DX12Mesh>> m_Meshes                  = {};
        ///commands
